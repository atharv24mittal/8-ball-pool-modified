...
pygame.font.init()
# used fonts
mainFont = pygame.font.SysFont("impact", 40)
...
pool_cue_original = pygame.image.load('assets/image/cue (1).png')
...
cue_ball = Ball('', 550, 400, 'assets/image/ball16.png')
...
balls = [cue_ball, Ball('solids', 950, 400, 'assets/image/ball1.png'), Ball('solids', 986, 420, 'assets/image/ball2.png'),
         Ball('solids', 1022, 420, 'assets/image/ball3.png'), Ball('solids', 1022, 360, 'assets/image/ball4.png'),
         Ball('solids', 968, 390, 'assets/image/ball5.png'), Ball('solids', 1004, 410, 'assets/image/ball6.png'),
         Ball('solids', 1004, 370, 'assets/image/ball7.png'),
         Ball('eight', 986, 400, 'assets/image/ball8.png'), Ball('stripes', 986, 380, 'assets/image/ball9.png'),
         Ball('stripes', 1004, 430, 'assets/image/ball10.png'), Ball('stripes', 1004, 390, 'assets/image/ball11.png'),
         Ball('stripes', 1022, 440, 'assets/image/ball12.png'), Ball('stripes', 1022, 380, 'assets/image/ball13.png'),
         Ball('stripes', 968, 410, 'assets/image/ball14.png'), Ball('stripes', 1022, 400, 'assets/image/ball15.png')
         ]
...
def draw_background():
    ...
    gameDisplay.blit(mainFont.render('PLAYER 1', 1, BLACK), (50, 50))
    gameDisplay.blit(mainFont.render(p1_colour.upper(), 1, RED), (50, 90))
    gameDisplay.blit(mainFont.render('PLAYER 2', 1, BLACK), (1050, 50))
    gameDisplay.blit(mainFont.render(p2_colour.upper(), 1, RED), (1050, 90))
    gameDisplay.blit(mainFont.render('PLAYER ' + str(player_turn.number) + '\'S TURN', 1, RED), (500, 50))
...
def draw_potted_balls():
    for index in range(len(potted_balls)):
        gameDisplay.blit(potted_balls[index].sprite, (250 + (index * 25), 650))
